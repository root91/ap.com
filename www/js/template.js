...
$('.slide-text').airport(['професионалы? ', 'пиздюки', 'а не професионалы']);
$('.slide-text1').airport(['задроты', 'гавно', 'лопата']);
$('.slide-text2').airport(['задроты', 'гавно', 'лопата']);
...
$(document).ready(function() {
    (function($) {
        ...
        function setColumnWidth() {
            var winWidth = $(window).width(),
                postWidth = Math.floor(winWidth / getNumbColumns());
        }
